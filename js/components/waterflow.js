...
var DT_waterflow = (function () {
    function buildHTML(me, device) {
        ...
        html +=
            '#' +
            coldGradId +
            ' > stop:first-child { stop-color: var(--waterflow-cold-light); }'
        html +=
            '#' +
            coldGradId +
            ' > stop:last-child { stop-color: var(--waterflow-cold-dark); }'
        html +=
            '#' +
            hotGradId +
            ' > stop:first-child { stop-color: var(--waterflow-hot-light); }'
        html +=
            '#' +
            hotGradId +
            ' > stop:last-child { stop-color: var(--waterflow-hot-dark); }'
        html += '</style>'
        ...
        // Drop outline
        html +=
            '<path d="M61.38,18.68c-4.77,-6.86,-8.90,-12.78,-9.89,-15.62c-0.22,-0.62,-0.80,-1.04,-1.47,-1.05c-0.61,0.02,-1.26,0.40,-1.49,1.01c-1.02,2.68,-4.93,8.30,-9.47,14.81C28.68,32.75,14.46,53.18,14.46,66.51c0,19.61,15.94,35.55,35.55,35.55s35.55,-15.94,35.55,-35.55C85.50,53.39,71.58,33.34,61.38,18.68z" fill="none" stroke="white" stroke-width="2" />'

        // Filled drop
        var gradientId = waterType === 'hot' ? hotGradId : coldGradId
        html +=
            '<path d="M61.38,18.68c-4.77,-6.86,-8.90,-12.78,-9.89,-15.62c-0.22,-0.62,-0.80,-1.04,-1.47,-1.05c-0.61,0.02,-1.26,0.40,-1.49,1.01c-1.02,2.68,-4.93,8.30,-9.47,14.81C28.68,32.75,14.46,53.18,14.46,66.51c0,19.61,15.94,35.55,35.55,35.55s35.55,-15.94,35.55,-35.55C85.50,53.39,71.58,33.34,61.38,18.68z" fill="url(#' +
            gradientId +
            ')" clip-path="url(#' +
            clipId +
            ')" />'
